...
def process_file(f):
    ...
    for msg in messages:  # msg is of type "proto"
        ...
        if message_type == "10":  # Kerberos AS-REQ
            ...
            r = msg.xpath(
                './/field[@name="kerberos.padata"]//field[@name="kerberos.PA_ENC_TIMESTAMP.encrypted"]') or msg.xpath(
            ...
            # locate cname
            r = msg.xpath(
                './/field[@name="kerberos.req_body_element"]//field[@name="kerberos.KerberosString"]') or msg.xpath(
                './/field[@name="kerberos.kdc_req_body"]//field[@name="kerberos.name_string"]') or msg.xpath(
